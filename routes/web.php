...
Route::middleware(['auth', 'verified', 'role:admin'])->group(function () {
    ...
    Route::post('cheque-books', [ChequeBookController::class, 'store'])->name('cheque-books.store');
    Route::post('cheque-books/{chequeBook}/close', [ChequeBookController::class, 'close'])->name('cheque-books.close');
    ...
    Route::post('projects/{project}/merge', [ProjectController::class, 'merge'])->name('projects.merge');
    Route::post('projects/overhead-settings', [ProjectController::class, 'updateOverheadSettings'])->name('projects.overhead-settings.update');

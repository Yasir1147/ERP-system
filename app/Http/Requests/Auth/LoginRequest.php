...
class LoginRequest extends FormRequest
{
    ...
    public function authenticate(): void
    {
        ...
        if ($user->isOfficeStaff() && ! OfficeStaff::where('user_id', $user->id)->where('status', 'active')->exists()) {
            $this->failAuthentication();
        }
        ...
        if ($password === '' || ! Auth::attempt(['email' => $user->email, 'password' => $password], $this->boolean('remember'))) {
            $this->failAuthentication();
        }
